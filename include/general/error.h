...
// Class faite for tester la repetitivite (determinise) de l'execution d'un programme
class cMajickChek
{
    public :
        cMajickChek();
...
class ElEM   // Elise error Message
{
...
void OpenFileDebug(const std::string &); // error if ouverture multiple
